<template>
  <el-dialog :visible.sync="dialogFormVisible" top="5vh" width="80%">
    ...
    <el-row>
      <el-col :span="6">
        <student-info :tsUserInfo="tsUserInfo" :type="planType" :planTime="planTime"></student-info>
      </el-col>
      <el-col :span="18">
        ...
        <el-row v-if='myWeekPlan.length>0' :gutter="20" v-for="(item, index) in myWeekPlan" :key="item.id">
          <el-col :span="24">
              ...
              <div>
                <el-row :gutter="20" style="margin-top: 12px; margin-bottom: 12px">
                  <el-col :span="10">
                    ...
                    <el-row style="margin-top: 6px; margin-bottom: 12px">
                      <el-tag v-for="(tag, index) in item.skillType" :key="index" style="margin-right: 16px">{{
                        tag
                      }}</el-tag>
                    </el-row>
                  </el-col>
                ...
                <el-row :gutter="24" style="margin-top: 12px; margin-bottom: 12px">
                  <comment
                    ...
                    :freshStudentReportId="item.id"
                    :realname="tsUserInfo.realName"
                    :userId="tsUserInfo.userId"
