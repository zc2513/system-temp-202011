<template>
  <el-form :inline="true" :model="formInline" class="box">
    <el-form-item label="监督节点编号:" class="ml10">
      <el-input v-model="formInline.code" clearable placeholder="请输入" />
    </el-form-item>
    <el-form-item label="监督节点名称:" class="ml10">
    ...
    <el-form-item label="是否监督预警节点:" class="ml10">
      <el-select v-model="formInline.isWarnNode" placeholder="请选择" clearable>
